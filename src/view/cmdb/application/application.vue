<template>
  <div>
    <div class="search-term">
      <el-form :inline="true" :model="searchInfo" class="demo-form-inline">
        <el-form-item label="路径">
          <el-input v-model="searchInfo.path" placeholder="名称" />
        </el-form-item>
    ...
    <el-table :data="tableData" border stripe @sort-change="sortChange" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="name" min-width="150" prop="name" sortable="custom" />
      <el-table-column label="url" min-width="150" prop="name" sortable="custom" />
    ...
    openDialog(type) {
      switch (type) {
        case 'add':
          ...
          break
        case 'edit':
          this.dialogTitle = '编辑Application'
          break
        default:
          break
      }
